...
macro(setup_compiler_options)
    ...
    if(YABIL_ENABLE_ASSEMBLER)
        enable_language(ASM_NASM OPTIONAL)
        set(YABIL_USE_ASM "${CMAKE_ASM_NASM_COMPILER_LOADED}" CACHE INTERNAL "")
        if(YABIL_USE_ASM)
    ...
    if(CMAKE_SYSTEM_PROCESSOR MATCHES "(x86)|(x86_64)|(amd64)")
        if(CMAKE_SIZEOF_VOID_P EQUAL 8)
            set(YABIL_SYSTEM_ARCHITECTURE "amd64" CACHE INTERNAL "")
        else()
            set(YABIL_SYSTEM_ARCHITECTURE "x86" CACHE INTERNAL "")
        endif()
    endif()
endmacro()
