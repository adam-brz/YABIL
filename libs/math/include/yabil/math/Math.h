...
YABIL_PUBLIC yabil::bigint::BigInt pow(const yabil::bigint::BigInt &number, const yabil::bigint::BigInt &n);
...
YABIL_PUBLIC yabil::bigint::BigInt factorial(uint64_t n);
...
YABIL_PUBLIC uint64_t log2_int(const yabil::bigint::BigInt &number);

/// @brief Calculate binary logarithm of specified number.
/// @param number \p BigInt Number to calculate logarithm for
/// @return Binary logarithm result
YABIL_PUBLIC double log2(const yabil::bigint::BigInt &number);
...
YABIL_PUBLIC double log(const yabil::bigint::BigInt &number, const yabil::bigint::BigInt &base);

/// @copydoc yabil::math::log(const yabil::bigint::BigInt &, const yabil::bigint::BigInt &)
YABIL_PUBLIC double log(const yabil::bigint::BigInt &number, double base = 10);
...
YABIL_PUBLIC yabil::bigint::BigInt gcd(yabil::bigint::BigInt number, yabil::bigint::BigInt other);
...
YABIL_PUBLIC std::pair<yabil::bigint::BigInt, std::pair<yabil::bigint::BigInt, yabil::bigint::BigInt>> extended_gcd(
...
YABIL_PUBLIC yabil::bigint::BigInt mod_inverse(const yabil::bigint::BigInt &a, const yabil::bigint::BigInt &n);
...
YABIL_PUBLIC yabil::bigint::BigInt sqrt(const yabil::bigint::BigInt &n);
...
YABIL_PUBLIC yabil::bigint::BigInt root(const yabil::bigint::BigInt &n, const yabil::bigint::BigInt &k);
