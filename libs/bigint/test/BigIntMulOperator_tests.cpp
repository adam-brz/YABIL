...
TEST_F(BigIntMulOperator_tests, mulHuge)
{
    ...
    const BigInt big_int2(
        "897658916487123710561764298721471562984798417289561298721831231891092840124217489721874241247");

    const BigInt expected(
        "16990339616022290436059914713186431332183021198448594411348590884013170580827548715357286979670043816796295463"
        "338971101779185943176529708443007373708291711774966199862846607649901");
    const auto result = big_int1 * big_int2;
...
TEST_F(BigIntMulOperator_tests, mulHugeNegative)
{
    ...
    const BigInt expected(
        "-1699033961602229043605991471318643133218302119844859441134859088401317058082754871535728697967004381679629546"
        "3338971101779185943176529708443007373708291711774966199862846607649901");
    const auto result = big_int1 * big_int2;
