...
public:
    ...
    YABIL_PUBLIC explicit BigInt(const std::string_view &str, unsigned base = 10);
    ...
    YABIL_PUBLIC explicit BigInt(const std::vector<bigint_base_t> &raw_data, Sign sign = Sign::Plus);

    /// @copydoc yabil::bigint::BigInt::BigInt(const std::vector<bigint_base_t> &, Sign)
    YABIL_PUBLIC explicit BigInt(std::vector<bigint_base_t> &&raw_data, Sign sign = Sign::Plus);

    /// @copydoc yabil::bigint::BigInt::BigInt(const std::vector<bigint_base_t> &, Sign)
    YABIL_PUBLIC explicit BigInt(std::span<bigint_base_t const> raw_data, Sign sign = Sign::Plus);
    ...
    YABIL_PUBLIC std::string to_str(unsigned base = 10) const;
    ...
    YABIL_PUBLIC bool is_uint64() const;
    ...
    /// number)
    YABIL_PUBLIC Sign get_sign() const;

    /// @brief Set sign of the number.
    YABIL_PUBLIC void set_sign(Sign new_sign);
    ...
    YABIL_PUBLIC bool abs_greater(const BigInt &other) const;
    ...
    YABIL_PUBLIC bool abs_lower(const BigInt &other) const;
    ...
    YABIL_PUBLIC bool operator==(const BigInt &other) const;
    ...
    YABIL_PUBLIC BigInt operator+(const BigInt &other) const;
    ...
    YABIL_PUBLIC bigint_base_t operator%(bigint_base_t other) const;
    ...
    YABIL_PUBLIC BigInt operator-() const;
    ...
    YABIL_PUBLIC BigInt operator<<(uint64_t shift) const;
    ...
    YABIL_PUBLIC BigInt &operator+=(const BigInt &other);
    ...
    /// @return Reference to modified \p BigInt
    YABIL_PUBLIC BigInt &operator<<=(uint64_t shift);
    ...
    YABIL_PUBLIC BigInt operator++(int);
    ...
    YABIL_PUBLIC explicit operator bool() const
    {
        return !is_zero();
    }
    ...
    YABIL_PUBLIC std::pair<BigInt, BigInt> base_div(const BigInt &other) const;

    YABIL_PUBLIC friend std::ostream &operator<<(std::ostream &out, const BigInt &bigint);
    YABIL_PUBLIC friend std::istream &operator>>(std::istream &in, BigInt &bigint);

private:
    YABIL_PUBLIC void normalize();
