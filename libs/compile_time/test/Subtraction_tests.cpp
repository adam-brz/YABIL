...
TEST_F(ConstBigIntAddition_tests, canSubtractTwoNumbers)
{
    constexpr ConstBigInt a(std::array<bigint_base_t, 3>{1, 1, 1});
    constexpr ConstBigInt b(std::array<bigint_base_t, 3>{2, 2, 1});
    constexpr ConstBigInt<Sign::Minus, 2> expected(std::array<bigint_base_t, 2>{1, 1});
